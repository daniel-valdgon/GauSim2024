...
keep hid pc_hhdr pl_abs pl_ext pl_fd wta_hh_c ndfdecil ndecil hhsize rururb hhtexp wta_pop_c hhtexpdr hhtexpdr1 hhtexpdr2
...
keep hhid hhweight hhsize code purchase TVA /* poste milieu wilaya */ c_inf_mean decile_expenditure

* HH and product level
collapse (sum) purchase [aw=hhweight], by(hhid hhsize code TVA /* poste milieu wilaya */ c_inf_mean decile_expenditure)

ren (code purchase hhsize) (codpr depan hsize)
...
*include "$thedo_pre/Consumption_NetDown.do"
*replace depan = achats_net_VAT
*keep c_inf_mean codpr decile_expenditure depan depan2 depan_for depan_inf hhid hsize informal_purchase sector
