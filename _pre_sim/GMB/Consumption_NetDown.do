...
gen     shock = 0
replace shock = $subsidy_shock_elec_SY 	if Secteur==14
...
gen subsidy_fuel_SY = q_petrol*($mp_petrol_SY - $sp_petrol_SY ) + q_diesel*($mp_diesel_SY - $sp_diesel_SY ) + q_Kerosene*($mp_Kerosene_SY - $sp_Kerosene_SY )
