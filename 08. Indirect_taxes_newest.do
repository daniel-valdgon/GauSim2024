...
*merge m:1 codpr using "$presim/IO_sector.dta", nogen keepusing(sector) keep(1 3)
...
/*
gunique hhid codpr informal_purchase sector

gen comp = !inrange(x_bef, x_aft * 0.9999, x_aft * 1.0001) 

tab comp informal_purchase
tab comp [iw = achats_avec_excises]

gen all = 1
egen tot = total(all), by(codpr hhid sector)
tab informal_purchase tot

br hhid codpr informal_purchase sector pourcentage aux* achats* if tot == 1 & informal_purchase == 1
*/
...
*gsort hhid codpr informal_purchase
*br hhid codpr informal_purchase achats_avec_excises TVA TVA_indirect_shock TVA_direct TVA_indirect
