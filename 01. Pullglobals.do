...
*--------------------------------------------------------------------------------
	...
	*==================================================================================
	...
	import excel "$xls_out", sheet(settingshide) first clear
	...
	*==================================================================================
	...
	save "$presim/IO_sector.dta", replace
	...
	* Fixed sectors. To move to excel file...
	...
	*if $TVA_simplified == 0{
		import excel "$xls_sn", sheet("TVA_raw_$country") firstrow clear
		drop produit
		drop if codpr==.
	...
	*==================================================================================
	dis "==============            Fertilizer Subsidies       					==========="
	*==================================================================================
	*import excel "$xls_sn", sheet(fertilizer_raw) first clear
	...
	****  CMU & Health
		...
		foreach z of local Programme{
		 ...
		 keep Beneficiaires Montant Programme
...
if ("`c(username)'"=="gabriellombomoreno") global save_scenario = "$save_scenario2"
