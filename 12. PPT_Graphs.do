...
\*==============================================================================*/
	...
	*******************************************************************
	...
	if "`c(username)'"=="gabriellombomoreno" {
		...
		global sheetname 	"MRT_VAT_ref MRT_VAT_sim1 MRT_VAT_sim2 Ref_2018 SEN_VAT_ref SEN_VAT_sim1 SEN_VAT_sim2" // No dejar espacios o espacios dobles...
	}
	...
	if "`c(username)'"=="wb621266" {
		...
		global xls_sn    	"${path}/03_Tool/SN_Sim_tool_VI_`c(username)'_2.xlsx" 
		global xls_out    	"${path}/03_Tool/Graphs_`c(username)'.xlsx" 
	...
	*drop _merge
	...
	merge 1:m hhid using "$tempsim/FinalConsumption_verylong.dta", nogen 
